...
height = 6.0
meshFilePath = "{MESHES}/msh/3D/column_hexas.msh"

run = False
plot = True

stepInTimeSamples = [1, 2, 10, 25, 50, 65]
...
def main_run():
	problemData = PyEFVLib.ProblemData(
		...
		numericalSettings = PyEFVLib.NumericalSettings( timeStep = timeStep, finalTime = finalTime, maxNumberOfIterations = 600 ),
		...
		boundaryConditions = PyEFVLib.BoundaryConditions({
			'u_x': {
				...
				'Bottom': { 'condition' : PyEFVLib.Neumann, 'type' : PyEFVLib.Constant, 'value' : 0.0 },
				'Top': { 'condition' : PyEFVLib.Neumann, 'type' : PyEFVLib.Constant, 'value' : 0.0 },
			...
			'u_z': {
				...
				'West': { 'condition' : PyEFVLib.Neumann, 'type' : PyEFVLib.Constant, 'value' : 0.0 },
				'East': { 'condition' : PyEFVLib.Neumann, 'type' : PyEFVLib.Constant, 'value' : 0.0 },
				'Top': { 'condition' : PyEFVLib.Neumann, 'type' : PyEFVLib.Constant, 'value' : load },
				'Bottom': { 'condition' : PyEFVLib.Dirichlet, 'type' : PyEFVLib.Constant, 'value' : 0.0 },
				'North': { 'condition' : PyEFVLib.Neumann, 'type' : PyEFVLib.Constant, 'value' : 0.0 },
				'South': { 'condition' : PyEFVLib.Neumann, 'type' : PyEFVLib.Constant, 'value' : 0.0 },
			},
			'p': {
				...
				'East': { 'condition' : PyEFVLib.Neumann, 'type' : PyEFVLib.Constant, 'value' : 0.0 },
				'Bottom': { 'condition' : PyEFVLib.Neumann, 'type' : PyEFVLib.Constant, 'value' : 0.0 },
				'Top': { 'condition' : PyEFVLib.Dirichlet, 'type' : PyEFVLib.Constant, 'value' : 0.0 },
				'North': { 'condition' : PyEFVLib.Neumann, 'type' : PyEFVLib.Constant, 'value' : 0.0 },
				'South': { 'condition' : PyEFVLib.Neumann, 'type' : PyEFVLib.Constant, 'value' : 0.0 },
			},
		}),
...
def main_plot():
	...
	for idx,t in zip(stepInTimeSamples,times_1):
		...
		ax[0][0].scatter(p_n*kPa, Z, color="k", marker=".",linewidth=0.5)
	...
	for idx,t in zip(stepInTimeSamples,times_1):
		...
		w_n = df[f"TimeStep{idx} - u_z"]
		ax[0][1].plot(w*mm, z)
		ax[0][1].scatter(w_n*mm, Z, color="k", marker=".",linewidth=0.5)
